...
const topPadding = (Platform.OS === 'ios') ? 100 : 90
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        <View style={[styles.subjectContainer, {paddingTop: topPadding + this.props.questionContainerHeight}]}>
          <Animated.View
            ...
            <View style={swipeableSize}>
              <SwipeSubject
                ...
                prefetchNextSubject={this.props.prefetchNextSubject}
              />
