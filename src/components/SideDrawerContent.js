...
class SideDrawerContent extends Component {
  constructor(props) {
    ...
    this.goPublications = this.goPublications.bind(this)
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={this.goAbout} style={styles.linkContainer}>
          <StyledText
            textStyle={'largeLink'}
            text={'About'} />
        </TouchableOpacity>

        <TouchableOpacity onPress={this.goPublications} style={styles.linkContainer}>
          <StyledText
            textStyle={'largeLink'}
            text={'Publications'} />
        </TouchableOpacity>
